...
pyinstaller --noconfirm --onedir --windowed --contents-directory "Spectrum Control" --icon "assets\Icon.ico" --add-data "Instrument Control GUI.kv;." --add-data "Icon.png;." "Instrument Control GUI.py"
"""
